...
> Note: This file remains as the comprehensive design narrative for compatibility and conflict minimization.
> The progressive-disclosure hierarchy lives in `docs/design/` and should be used as the canonical day-to-day working set.
>
> - `docs/design/README.md`
> - `docs/design/01-vision-pillars.md`
> - `docs/design/02-core-loops-systems.md`
> - `docs/design/03-ui-north-star.md`
> - `docs/design/04-staged-delivery-plan.md`
> - `docs/design/05-open-questions-risks.md`
> - `docs/design/06-consolidation-log.md`
